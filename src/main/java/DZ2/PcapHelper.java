...
public class PcapHelper {
     ...
     */
    public PcapHelper(String ifaceName, int T) throws PcapNativeException {
    ...
    private PcapHandle openIFaceToCapturePackets(String ifaceName, int T) throws PcapNativeException {
